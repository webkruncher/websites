...
JsonTree.prototype.Print = function ( )
{
	return "x"
}
...
//			if( typeof this[ndx].Submit == 'function' )
//				result[ ndx ] = this[ ndx ].Submit()
			//if( typeof this[ndx] == 'string' )
			//	result[ ndx ]=this[ ndx ]
			//if( typeof this[ndx] == 'object' )
			//	result[ ndx ]=this[ ndx ]
		}
	return result
}
...
JsonTree.prototype.buildjson = function ( json, name, parentobject )
{
		...
		if ( typeof json == 'object' )
		{
			for ( left in json )
			{
				Trace( "LeftObject" + JSON.stringify( json[ left ] ) + "_Object_"+name+"_"+left )
				css="color:gold;"; 
				OOO="Label"
		...
		{
				//Trace( typeof json[ left ] + "_String_"+name+"_"+json )
